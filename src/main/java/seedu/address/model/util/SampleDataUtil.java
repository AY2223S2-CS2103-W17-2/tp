...
public class SampleDataUtil {
    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Charlotte Oliveiro"), new Postal("932283"), new Email("charlotte@example.com"),
                new Address("Blk 11 Ang Mo Kio Street 74, #11-04"), EMPTY_REMARK,
                getTagSet("neighbours")),
            new Person(new Name("David Li"), new Postal("910312"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), EMPTY_REMARK,
                getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), new Postal("924921"), new Email("irfan@example.com"),
                new Address("Blk 47 Tampines Street 20, #17-35"), EMPTY_REMARK,
                getTagSet("classmates")),
            new Person(new Name("Roy Balakrishnan"), new Postal("926247"), new Email("royb@example.com"),
